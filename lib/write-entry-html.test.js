...
test('writeFile creates folder as filename without extension', () => {
...
test('writeFile creates folder as filename with extension', () => {
    const content = 'content'
...
test('writeFile creates file called index with content inside created folder.', () => {
    const content = 'content'
    const relativePath = 'relative.md'
    const relativePathWithoutExtensions = 'relative'
    const argv  = {
